...
const MOCK_NOTIFICATIONS: InAppNotification[] = [
  ...
  { id: "NTF002", type: "system", title: "Scheduled Maintenance Tonight", message: "PredictEx will be under maintenance from 2:00 AM - 4:00 AM PHT. Your bets and balances are safe.", target: "all", targetDetail: "All users", status: "scheduled", sentAt: "2026-03-14 00:00", readRate: 0, clickRate: 0, recipients: 485230, createdBy: "Carlos Reyes" },
