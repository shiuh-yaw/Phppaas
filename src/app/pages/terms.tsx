...
const SECTIONS = [
  { num: "1", title: "Pagtanggap sa mga Tuntunin", content: "Sa paggamit ng Lucky Taya platform (\"Serbisyo\"), sumasang-ayon ka sa mga Terms of Service na ito. Kung hindi ka sumasang-ayon, huwag gamitin ang platform. Ang Lucky Taya ay pinapatakbo ng PrediEx Inc. at lisensyado ng PAGCOR." },
  ...
  { num: "7", title: "Intellectual Property", content: "Lahat ng content, design, at software sa Lucky Taya ay pagmamay-ari ng PrediEx Inc. Hindi maaaring kopyahin, i-distribute, o i-modify ang anumang bahagi ng platform nang walang nakasulat na pahintulot." },
